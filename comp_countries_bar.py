...
plt.xlabel('Percentage use of features that could make a unique Device Fingerprinting')
plt.ylabel('Countries capturing device fingerprinting data')
plt.title('EU countries capturing device fingerprinting features in percentages - Data from Feb 2019')
